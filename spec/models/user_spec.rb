...
describe User do
	...
	describe "when an email is too long" do
	...
	describe "when email format is invalid" do
		it "should be invalid" do
			# addresses = %w[user@foobar.com user_1@this.com user.this@that.com foo@foor+baz.com]
			addresses = %w[david.reed.schmidt@gmail]
	...
	describe "when email format is valid" do
		it "should be valid" do
			...
			addresses = %w[david.reed.schmidt@gmail.com]
